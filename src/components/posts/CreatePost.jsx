    ...
    <Box sx={{ maxWidth: 720, mx: 'auto' }}>
      ...
      >
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
          Share your essays, thoughts, or observations with the community.
        </Typography>
        ...
        <Box component="form" onSubmit={handleSubmit(onSubmit)} noValidate>
          <Stack spacing={3}>
            ...
            <TextField
              ...
              placeholder="What are you thinking about? Markdown formatting is supported..."
              {...register('content', {
              ...
              label={
                <Box>
                  <Typography variant="body2" sx={{ fontWeight: 500 }}>
                    {publishedValue ? 'Publish immediately' : 'Save as draft'}
                  </Typography>
                  <Typography variant="caption" color="text.secondary">
                    {publishedValue
